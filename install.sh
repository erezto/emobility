...
/usr/bin/mysqld_safe --user=root --datadir='/data'  --bind-address=127.0.0.1 &
sleep 10
/usr/bin/mysqladmin -u root password "admin" && /usr/bin/mysql -u root -p"admin" < /opt/emobility/scripts/initDB.sql
